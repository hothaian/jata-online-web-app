  ...
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      const usersData = [
        ...
        { username: 'husky', email: 'husky@gmail.com', role_id: 1, first_name: 'Husky', last_name: 'UW', gender: 'Male', date_of_birth: '1996-08-22', profile_pictureUrl: 'https://seattlerefined.com/resources/media/d91f0c30-0e56-4f27-a602-250faecd22ee-large16x9_Handsomeonfield.jpg?1591989197391', createdAt: currentDate, updatedAt: currentDate }
      ];
      ...
      const addressesData = [
        ...
        {
          user_id: 11,
          street_address: "1900 Commerce St",
          city: "Tacoma",
          state: "WA",
          zip_code: "98402",
          country: "USA",
      ...
      const sellpostsData = [
        ...
        { seller_id: 11, item_name: 'Suit', description: 'Leather ', price: 299.99, quantity: 60, size: '40R', gender: 'Male', color: 'Navy', brand: 'Hugo Boss', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://i5.walmartimages.com/asr/4756ae16-a735-4aee-8b29-d3842937aabf_1.4d2c5e2c58f582d966d756fcd96ebfd5.jpeg' },
        ...
        { seller_id: 11, item_name: 'Jeans', description: 'Slim-fit jeans', price: 49.99, quantity: 40, size: '32', gender: 'Male', color: 'Denim', brand: 'Levi\'s', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://lsco.scene7.com/is/image/lsco/015504886-front-pdp?fmt=avif&qlt=40&resMode=bisharp&fit=crop,0&op_usm=0.6,0.6,8&wid=880&hei=968' },
        ...
        { seller_id: 11, item_name: 'Earrings', description: 'Business suit', price: 299.99, quantity: 10, size: '40R', gender: 'Male', color: 'Navy', brand: 'Hugo Boss', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://www.gotitabrands.com/wp-content/uploads/2019/05/Sleeveless-Maxi-Dresses-For-Women-Halter-Open-Back-Dress-With-Headscarf-Orange-Dress-1080x1620.jpg' },
        { seller_id: 11, item_name: 'Sunglasses', description: 'Polarized sunglasses', price: 79.99, quantity: 60, color: 'Black', brand: 'Ray-Ban', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://images2.ray-ban.com//cdn-record-files-pi/785cd2a8-5933-4d14-b145-a35800039b33/f150fe44-f372-4f0e-add9-b01300c1c1b9/0RB2140__901__P21__shad__qt.png?impolicy=RB_Product_clone&width=1024&bgc=%23f2f2f2' },
        { seller_id: 11, item_name: 'Scarf', description: 'Cashmere scarf', price: 39.99, quantity: 50, color: 'Red', brand: 'Burberry', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://assets.burberry.com/is/image/Burberryltd/A539A9B1-DE81-4F9D-B41B-5055319CEB4F?$BBY_V3_SL_1$&wid=2500&hei=2500' },
        { seller_id: 10, item_name: 'Suit', description: 'Gold suit', price: 299.99, quantity: 10, size: '40R', gender: 'Male', color: 'Navy', brand: 'Hugo Boss', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://cdn.shopify.com/s/files/1/1025/3059/products/NAVY_BLUE_SUIT__075_0ba78598-6c22-4024-820e-019a5fdb109a_900x1250_crop_center.jpg?v=1643118883' },
        { seller_id: 11, item_name: 'Jeans', description: 'Business suit', price: 299.99, quantity: 30, size: '40R', gender: 'Male', color: 'Navy', brand: 'Hugo Boss', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://cdn.shopify.com/s/files/1/1025/3059/products/NAVY_BLUE_SUIT__075_0ba78598-6c22-4024-820e-019a5fdb109a_900x1250_crop_center.jpg?v=1643118883' },
        { seller_id: 11, item_name: 'Suit', description: 'Business suit', price: 299.99, quantity: 10, size: '40R', gender: 'Male', color: 'Navy', brand: 'Hugo Boss', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://th.bing.com/th/id/OIP.87O1t_9kS1rXcZRt3wS_TgHaHa?rs=1&pid=ImgDetMain' },
        { seller_id: 11, item_name: 'Suit', description: 'Leather ', price: 299.99, quantity: 60, size: '40R', gender: 'Male', color: 'Navy', brand: 'Hugo Boss', condition: 'New', createdAt: currentDate, updatedAt: currentDate, picUrl: 'https://i5.walmartimages.com/asr/4756ae16-a735-4aee-8b29-d3842937aabf_1.4d2c5e2c58f582d966d756fcd96ebfd5.jpeg' },
      ];
      ...
      const sellpostCategoriesData = [
        ...
        { category_id: 1, sellpost_id: 11, createdAt: currentDate, updatedAt: currentDate },
        { category_id: 2, sellpost_id: 12, createdAt: currentDate, updatedAt: currentDate },
        { category_id: 3, sellpost_id: 13, createdAt: currentDate, updatedAt: currentDate },
        { category_id: 2, sellpost_id: 14, createdAt: currentDate, updatedAt: currentDate }

      ];

            
      const ordersData = [
        {order_id: 1, buyer_id: 2, total_price: 52.37, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 2, buyer_id: 4, total_price: 94.18, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 3, buyer_id: 6, total_price: 83.69, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 4, buyer_id: 7, total_price: 32.14, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 5, buyer_id: 8, total_price: 65.52, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 6, buyer_id: 2, total_price: 28.44, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 7, buyer_id: 3, total_price: 48.29, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 8, buyer_id: 5, total_price: 73.87, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 9, buyer_id: 1, total_price: 36.75, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 10, buyer_id: 2, total_price: 49.61, order_shipping_state: 'Shipped', shipping_address_id: 1, createdAt: currentDate, updatedAt: currentDate}
      ];
      
      const orderedItem = [
        {order_id: 1, quantity: 6, sellpost_id: 3, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 1, quantity: 8, sellpost_id: 2, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 2, quantity: 2, sellpost_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 2, quantity: 5, sellpost_id: 4, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 3, quantity: 7, sellpost_id: 2, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 3, quantity: 3, sellpost_id: 4, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 4, quantity: 9, sellpost_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 4, quantity: 4, sellpost_id: 12, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 5, quantity: 6, sellpost_id: 5, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 5, quantity: 2, sellpost_id: 2, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 6, quantity: 1, sellpost_id: 4, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 6, quantity: 8, sellpost_id: 7, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 7, quantity: 5, sellpost_id: 3, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 7, quantity: 4, sellpost_id: 2, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 8, quantity: 7, sellpost_id: 1, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 8, quantity: 3, sellpost_id: 5, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 9, quantity: 10, sellpost_id: 2, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 9, quantity: 1, sellpost_id: 4, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 10, quantity: 3, sellpost_id: 5, createdAt: currentDate, updatedAt: currentDate},
        {order_id: 10, quantity: 7, sellpost_id: 1, createdAt: currentDate, updatedAt: currentDate}
      ];
